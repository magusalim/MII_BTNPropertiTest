...
// Negative Case
if (form1.isEmpty() || form2.isEmpty() || form3.isEmpty()) { // Negative Case for empty value
...
else if (form1 <= form2) { // Negative case for value Penghasilan <= Pengeluaran
	...
	// Price Verification with Formula : (Penghasilan - Pengeluaran) * (Jumlah Bulan * Jangka Waktu) / 3
